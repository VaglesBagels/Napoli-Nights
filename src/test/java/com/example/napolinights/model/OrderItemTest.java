...
class OrderItemTest {
    ...
    void testToString() {
        ...
        String expected = "OrderItem{orderItemID=10, orderID=1, menuID=2, quantity=3, itemPrice=10.5, specialInstructions='', menuName='null', menuPrice=0.0}";
    ...
    void testToStringWithEdgeValues() {
        ...
        String expected = "OrderItem{orderItemID=0, orderID=0, menuID=0, quantity=" + Integer.MAX_VALUE + ", itemPrice=" + Double.MAX_VALUE + ", specialInstructions='', menuName='null', menuPrice=0.0}";
